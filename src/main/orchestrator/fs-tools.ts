...
toolRegistry.register({
  ...
  name: "读取文件",
  description:
    "读取本地文本文件（小说、笔记、代码、配置、日志等）。" +
    "返回带行号的文本内容。文件超过 256KB 会自动截断；可用 startLine/maxLines 翻页。" +
    "用户提到任何本地文件路径时优先调此工具，不要凭记忆或编造内容。" +
    "参数：path (必填，绝对路径)，startLine (可选，从第几行开始，默认 1)，maxLines (可选，最多多少行，默认 500)。",
  enabled: true,
  risk: "fs-read",
  inputSchema: {
    type: "object",
